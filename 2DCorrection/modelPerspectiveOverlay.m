function simScan = modelPerspectiveOverlay(AngleStart,AngleSize,CameraOffset,phiN)
...
line(x_R,y_R,'color','r','lineWidth',2);
line([x_R ; x_End],[y_R ; y_End],'color','r','lineWidth',2);
line(x_End,y_End,'color','r','lineWidth',2);
